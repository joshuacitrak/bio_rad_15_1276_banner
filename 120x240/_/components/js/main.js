function playAd(){  
    ...
    stl.from('#bradSvg1Container', 15, {scale:1.5, x:-100, y:-80, rotationX:20, rotationY:30, rotationZ:-20, force3D:true})
       ...
       .to("#bradSvg2Container", 3, {rotationY:0,  x:-130, y: 0, scale:1.3, force3D:true}, 3)
        .to("#bradSvg2Container", 3, {rotationY:20,  x:-120, scale:1, z:0,force3D:true}, 6)
        .to("#bradSvg2Container", 1.5, {rotationY:0,  x:-100, scale:1.2 ,y:-50 }, 9)
        .to("#bradSvg2Container", 3, {opacity:0, scale:1.5, rotationY:-20,  x:-150,ease: Power3.easeOut }, 10.5);
...
function checkInit() {
    ...
    TweenLite.set('#bradSvg1Container', {rotationX:35, rotationZ: -30, x:-60, y:-35, force3D:true, scale:.7});
